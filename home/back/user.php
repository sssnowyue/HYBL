<?php
require_once("../../admin/back/oneinfor.php");
?>
...
<!-- banner-body -->
	<div class="banner-body">
		...
		<span>&nbsp; &nbsp;邮 &nbsp; 箱:<?php echo $email ?> &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; <br><br><br><br><br>&nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; </span>
		
		&nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;
		<?php
			if ($accout_type==0) {
				?>
					<a href="../../admin/back/upgrade.php?person_id=<?php echo $person_id; ?>"><button >升级为管理员</button></a>
				<?php
			}
		?>

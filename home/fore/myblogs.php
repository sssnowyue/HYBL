<?php
require_once("../../admin/fore/myblogs.php");
?>
<!DOCTYPE html>
<html>
<head>
						...
						<div class="collapse navbar-collapse nav-wil" id="bs-example-navbar-collapse-1">
							<nav class="stroke">
								<ul class="nav navbar-nav">
									...
									<li class="active"><a href="myblogs.php"><i class="picture1"></i>我的博文</a></li>
						...
						foreach ($data as $key => $value){
							...
							<div class="col-md-4 banner-left">						
								<div class="col-xs-9 banner-right1">
									<a href="blog_all.php?blog_id=<?php echo $blog_id; ?>"><h3><?php echo $value['title']; ?></h3></a>
								</div>
								<div class="col-xs-90 banner-right11">
									<time datetime="2016-12-27T10:29:00.000Z" itemprop="datePublished"><?php echo $value['update_at']; ?>
										
									</time>
								</div>
								<div class="clearfix"> </div>
								<a href="../../admin/fore/delmyblog.php?blog_id=<?php echo $blog_id; ?>">
